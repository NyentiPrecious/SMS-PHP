...
<div class="col-md-12">
	<div class="col-md-12">
		<div class="panel panel-full-color panel-primary">
			<div class="panel-heading panel-heading-contrast" style="background-color: #CCCCFF; color: black;">
				<strong>Add
					Credit</strong>
				...
				<div class="panel-heading ">
					...
					<div class="col-md-6">
						...
						<div class="col-md-3" style="margin-left: -10%;">
							<input type="text" name="bill_name" id="bill_name" value="" style="height: 25px;"
								required="">
						</div>
					</div>
					...
					<span id="srch_ty">
						...
						<div class="col-md-12">
							<div class="col-md-6">
								...
								<div class="col-md-1">
									<input type="text" name="tr_amt" id="tr_amt" class="form-control input-xs" value="0"
										style="width: 100px;">
								</div>

							</div>
							<div class="col-md-2" style="margin-left: -12%">
								<a class="btn btn-space md-trigger btn-primary" onclick="add_seller_row();"
									style="float: right;"><i class="icon icon-left mdi mdi-plus"></i>&nbsp;ADD
									PRODUCT</a>
							</div>
							<div class="col-md-2">
								<button type="submit" style="width:146px;" class="btn btn-space md-trigger btn-success"
									formtarget="_blank"><i class="icon icon-left mdi mdi-assignment"></i>&nbsp;Print
									Bill</button>
							</div>
						</div>
