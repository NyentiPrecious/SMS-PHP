...
<table class="table" align="center" border="1px dotted black;" width="75%">
	<tr>

		<br>
		<h1>
			<center><strong>Recent Goods</strong></center>
		</h1>
		<br>

	</tr>
	<tr>
		<td colspan="2"><strong>&nbsp;Bill No.&nbsp;:&nbsp;
				<?php echo $value['bill_id']; ?>
			</strong> </td>
		<td colspan="3"><strong>&nbsp;M/S&nbsp;:&nbsp;
				<?php echo ucwords($value['bill_name']); ?>
			</strong></td>
		<td colspan="2"><strong>&nbsp;Date&nbsp;:&nbsp;
				<?php echo $value['bill_entrydt']; ?>
			</strong></td>
	</tr>
	<tr>
		<td colspan="7">&nbsp;</td>
	...
	foreach ($detail as $key => $row) {
		...
		<tr>
			...
			<td>
				<center>
					<?php echo ucwords(strtoupper($row['ty_name'])); ?>
				</center>
			</td>
			<td>
				<center>
			...
			<td>
				<center>
					<?php echo $row['bp_price']; ?>
				</center>
			</td>
			<td>
				<center>
					<?php echo $row['bp_price'] * $row['bp_qty']; ?>
				</center>
			</td>
		</tr>
	...
	<tr>
		<td colspan="5"><strong>&nbsp;Rupees In Words&nbsp;:&nbsp;</strong>
			<?php echo convertNumberToWordsForIndia($value['bill_amt'] + $value['bill_tchrg']); ?>
		</td>
		<td colspan="2"><strong>&nbsp;Total&nbsp;:&nbsp;
				<?php echo $value['bill_amt'] + $value['bill_tchrg'] . "&nbsp;/-"; ?>
			</strong></td>
	</tr>
	<tr>
		<td colspan="2"><strong>&nbsp;GSTIN&nbsp;:&nbsp;
				<?php echo $value['bill_gst']; ?>
			</strong></td>
		<td colspan="3"><strong>&nbsp;&nbsp;Transport Charge&nbsp;:&nbsp;
				<?php echo $value['bill_tchrg']; ?>
			</strong></td>
		<td colspan="2"><strong>&nbsp;Transport no&nbsp;:&nbsp;
				<?php echo $value['bill_tno']; ?>
			</strong></td>
	</tr>
</table>