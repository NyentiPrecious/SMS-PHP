...
<table border="1" class="table table-condensed table-bordered" width="100%">
	...
	foreach ($detail as $key => $value) {
		...
		<tr>
			...
			<td>&nbsp;
				<?php echo ucwords($value['firm_name']); ?>
			</td>
			<td>&nbsp;
				<?php echo ucwords($value['cat_name']); ?>
			</td>
			<td>
				<center>
					<?php echo ucwords(strtoupper($value['ty_name'])); ?>
				</center>
			</td>
			<td>
				<center>
					<?php echo $value['bp_qty']; ?>
				</center>
			</td>
			<td>
				<center>
					<?php echo $value['bp_price']; ?>
				</center>
			</td>
			<td>
				<center>
					<?php echo $value['bp_price'] * $value['bp_qty']; ?>
				</center>
			</td>
		</tr>
	...
	<?php } ?>
	<tr>
		<td colspan="5"><strong>Rupees In Words&nbsp;:&nbsp;
				<?php echo convertNumberToWordsForIndia($row['bill_amt'] + $row['bill_tchrg']); ?>
			</strong></td>
		<td colspan="2"><strong>Total&nbsp;:&nbsp;
				<?php echo $row['bill_amt'] + $row['bill_tchrg'] . "&nbsp;/-"; ?>
			</strong></td>
	</tr>
	<tr>
		<td colspan="3"><strong>GSTIN&nbsp;:&nbsp;
				<?php echo $row['bill_gst']; ?>
			</strong></td>
		<td colspan="2"><strong>Transport Charge&nbsp;:&nbsp;
				<?php echo $row['bill_tchrg']; ?>
			</strong></td>
		<td colspan="2"><strong>Transport no&nbsp;:&nbsp;
				<?php echo $row['bill_tno']; ?>
			</strong></td>
	</tr>
</table>