...
<div id="edit-product" tabindex="-1" role="dialog" class="modal fade colored-header colored-header-primary">
  <div class="modal-dialog custom-width" style="height:200px;">
    <div class="modal-content">
      ...
      <!-- <div class="modal-footer">
        <button type="button" data-dismiss="modal" class="btn btn-default md-close">Cancel</button>
        <button type="submit" onclick="add_editpro(<?php echo $row['pro_id']; ?>);" data-dismiss="modal"
          class="btn btn-primary md-close">Proceed</button>
      </div> -->
    </div>
  </div>
</div>
...
<div class="col-md-12">
  <div class="col-md-12">
    ...
    <div class="panel panel-full-color">
      <!-- <div class="panel-heading panel-heading-contrast" style="background-color: #c1c1d3;"><strong>PRODUCTS</strong>
        <div class="tools"><span class="icon mdi"></span></div><span class="panel-subtitle"></span>
      </div> -->
      <div class="panel-body" style="background-color: #CCCCFF; display: flex; justify-content: space-between;">
        <!-- <div class="col-md-3">    
        ...
        <div class="col-md-3">
          ...
          <select style="margin-top: 1.5rem; " class="form-control input-xs chosen-select" id="spro_cat"
            onchange="srch_pro();">
        ...
        <div class="col-md-3">
          ...
          <select style="margin-top: 1.5rem; " class="form-control input-xs" required="" id="spro_firm"
            onchange="srch_pro();">
            <option value="">Select firm</option>
        ...
        <div class="col-md-3">
          ...
          <div class="btn-group btn-space">
            <button data-toggle="modal" data-target="#form-bp1"
              style="background-color: #4b4b61; color: white; border: 0; font-size: 1.5rem; "
              class="btn btn-space md-trigger "><i class="icon icon-left mdi mdi-shopping-cart-plus"></i> New
              Product</button>
          </div>
        </div>
      </div>
  ...
  <div style="background: linear-gradient(
    ...
    rgba(17, 17, 17, 1) 98%,
    rgba(17, 17, 17, 1) 100%
  );" class="panel panel-default panel-table">
            ...
            <tbody style="color:white;">
              ...
              foreach ($data as $row) {
                ...
                <tr>
                  ...
                  <!-- <td><input type="text" id="<?php echo $row['pro_id']; ?>" value="<?php echo $row['pro_sell_price']; ?>"
                      style="width: 80px; padding: 3px;" onkeyup="add_sell_price(this.value, this.id);">
                  </td> -->
                  ...
                  <td>
                    <center><button data-toggle="modal" data-target="#edit-product"
                        class="btn btn-space md-trigger btn-danger" onclick="edit_pro(<?php echo $row['pro_id']; ?>);"><i
                          class="icon icon-left mdi mdi-eyedropper"></i> EDIT</button></center>
                  </td>
                </tr>
              <?php } ?>
            </tbody>
