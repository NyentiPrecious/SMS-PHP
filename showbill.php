...
<div class="col-md-12">
  <div class="col-md-12">
    <div class="panel panel-full-color panel-CCCCFF">
      <div class="panel-heading panel-heading-contrast" style="background-color: #CCCCFF;"><strong>BILLING
          DETAILS</strong>
      ...
      <div class="panel-body" style="background-color: #607D8B;">
        <div class="col-md-4">
          ...
          <input type="text" value="" placeholder="Enter Name..." id="sfirm_name" onkeyup="srch_showbill();"
        ...
        <div class="col-md-4">
          ...
          <input type="text" value="" placeholder="Enter bill no." id="bill_no" onkeyup="srch_showbill();"
            class="form-control input-xs">
        </div>
      </div>
    </div>
          ...
          <table class="table ">
            <thead>
              <tr>
                ...
                <th>
                  <center>Transportation Charge</center>
                </th>
                <th>
            ...
            <tbody style="color:black;">
              ...
              <tr>
                ...
                <td>
                  <center><button data-toggle="modal" data-target="#form-bp1"
                      class="btn btn-danger text-center">View</button></center>
                </td>
              </tr>
              <?php //  } ?>
            </tbody>
